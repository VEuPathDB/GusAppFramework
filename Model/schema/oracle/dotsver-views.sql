...
/* dotsver-views.sql                                                                          */
/*                                                                                            */
/* This file was generated automatically by dumpSchema.pl on Tue Dec  9 16:13:29 EST 2003     */
/*                                                                                            */

SET ECHO ON
SPOOL dotsver-views.log

CREATE VIEW @oracle_dotsver@.AAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  feature_name_id,
 ...
 FROM AAFeatureImpVer
 WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.AAORTHOLOGEXPERIMENTVER
AS SELECT
  ...
  version_date,
  version_transaction_id 
FROM AASeqGroupExperimentImpVer
WHERE subclass_view = 'AAOrthologExperiment'
WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.AAORTHOLOGGROUPVER
AS SELECT
  ...
  version_date,
  version_transaction_id 
FROM AASequenceGroupImpVer
WHERE subclass_view = 'AAOrthologGroup'
WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.AAPARALOGEXPERIMENTVER
AS SELECT
  aa_seq_group_experiment_id,
  subclass_view,
  description,
...
CREATE VIEW @oracle_dotsver@.AAPARALOGGROUPVER
AS SELECT
  aa_sequence_group_id,
  subclass_view,
  name,
...
CREATE VIEW @oracle_dotsver@.AASEQGROUPEXPERIMENTVER
AS SELECT
  aa_seq_group_experiment_id,
  description,
  sequence_source,
...
CREATE VIEW @oracle_dotsver@.AASEQUENCEGROUPVER
AS SELECT
  aa_sequence_group_id,
  name,
  description,
...
CREATE VIEW @oracle_dotsver@.AASEQUENCEVER
AS SELECT
  aa_sequence_id,
  sequence_version,
  subclass_view,
  ...
  version_date,
  version_transaction_id 
 FROM AASequenceImpVer
 WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.AASEQVARIATIONVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  na_feature_id,
...
CREATE VIEW @oracle_dotsver@.ALLELEFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
  ...
  version_date,
  version_transaction_id 
 FROM NAFeatureImpVer
 WHERE subclass_view = 'AlleleFeature'
 WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.ASSEMBLYVER
AS SELECT
  na_sequence_id,
  sequence_version,
  sequence_type_id,
  ...
  version_date,
  version_transaction_id 
 FROM NASequenceImpVer
 WHERE subclass_view = 'Assembly'
 WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.BINDINGSITEFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.CHROMOSOMEELEMENTFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.COLLECTIONNAFEATUREVER
AS SELECT
  na_feature_id,
  subclass_view,
  sequence_ontology_id,
...
CREATE VIEW @oracle_dotsver@.DNAREGULATORYVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.DNASTRUCTUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.DOMAINFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.EPITOPEFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.EXONFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.EXTERNALAASEQUENCEVER
AS SELECT
  aa_sequence_id,
  subclass_view,
  molecular_weight,
...
CREATE VIEW @oracle_dotsver@.EXTERNALNASEQUENCEVER
AS SELECT
  na_sequence_id,
  sequence_version,
  sequence_type_id,
...
CREATE VIEW @oracle_dotsver@.GENEFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.GENOMICSEQUENCEVER
AS SELECT
  na_sequence_id,
  sequence_version,
  sequence_type_id,
...
CREATE VIEW @oracle_dotsver@.HEXAMERFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.IMMUNOGLOBULINVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.INFLECTIONPOINTFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.INPARALOGEXPERIMENTVER
AS SELECT
  ...
  version_date,
  version_transaction_id 
       FROM SeqGroupExperimentImpVer
       WHERE   subclass_view='InParalogExperiment'
       WITH CHECK OPTION;

CREATE VIEW @oracle_dotsver@.INPARALOGGROUPVER
AS SELECT
  sequence_group_id,
  name,
  description,
  ...
  version_date,
  version_transaction_id 
      FROM SequenceGroupImpVer
      WHERE    subclass_view = 'InParalogGroup'
      with check OPTION;

CREATE VIEW @oracle_dotsver@.INTRONFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.LOWCOMPLEXITYAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.LOWCOMPLEXITYNAFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.MASSSPECFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.MISCELLANEOUSVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.MOTIFAASEQUENCEVER
AS SELECT
  aa_sequence_id,
  sequence_version,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.NAFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.NASEQUENCEVER
AS SELECT
  na_sequence_id,
  sequence_version,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.ORTHOLOGEXPERIMENTVER
AS SELECT
  seq_group_experiment_id,
  subclass_view,
  algorithm_id,
...
CREATE VIEW @oracle_dotsver@.ORTHOLOGGROUPVER
AS SELECT
  sequence_group_id,
  subclass_view,
  name,
...
CREATE VIEW @oracle_dotsver@.OUTPARALOGEXPERIMENTVER
AS SELECT
  seq_group_experiment_id,
  subclass_view,
  algorithm_id,
...
CREATE VIEW @oracle_dotsver@.OUTPARALOGGROUPVER
AS SELECT
  sequence_group_id,
  name,
  description,
...
CREATE VIEW @oracle_dotsver@.PLASMOAPFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.POLYAFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.POSTTRANSLATIONALMODFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.PREDICTEDAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.PROMOTERFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.PROTEINFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.REPEATREGIONAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.REPEATSVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.REPLICATIONORIGINFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RESTRICTIONFRAGMENTFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RNAFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RNAREGULATORYFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RNASECONDARYSTRUCTUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RNASTRUCTUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.RNATYPEVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SAGETAGFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SCAFFOLDGAPFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SECONDARYSTRUCTUREAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SEQGROUPEXPERIMENTVER
AS SELECT
  seq_group_experiment_id,
  algorithm_id,
  description,
...
CREATE VIEW @oracle_dotsver@.SEQUENCEGROUPVER
AS SELECT
  sequence_group_id,
  name,
  description,
...
CREATE VIEW @oracle_dotsver@.SEQVARIATIONVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SIGNALPEPTIDEFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SOURCEVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.SPLICEDNASEQUENCEVER
AS SELECT
  na_sequence_id,
  sequence_version,
  sequence_type_id,
...
CREATE VIEW @oracle_dotsver@.SPLICESITEFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.STSVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TANDEMREPEATFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TERTIARYSTRUCTUREAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TRANSCRIPTVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TRANSLATEDAAFEATUREVER
AS SELECT
  aa_feature_id,
  aa_sequence_id,
  na_feature_id,
...
CREATE VIEW @oracle_dotsver@.TRANSLATEDAASEQUENCEVER
AS SELECT
  aa_sequence_id,
  sequence_version,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TRANSPOSABLEELEMENTVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.TRIVIALTRANSLATIONVER
AS SELECT
  aa_sequence_id,
  sequence_version,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.UTRFEATUREVER
AS SELECT
  na_feature_id,
  na_sequence_id,
  subclass_view,
...
CREATE VIEW @oracle_dotsver@.VIRTUALSEQUENCEVER
AS SELECT
  na_sequence_id,
  sequence_version,
