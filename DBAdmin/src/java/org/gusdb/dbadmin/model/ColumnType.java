...
public final class ColumnType {
    ...
    public static ColumnType getInstance(String id) {        
        if      ( id.compareToIgnoreCase("CHARACTER") == 0 ) { return CHARACTER; }
        else if ( id.compareToIgnoreCase("CLOB"     ) == 0 ) { return CLOB; }
        else if ( id.compareToIgnoreCase("DATE"     ) == 0 ) { return DATE; }
        else if ( id.compareToIgnoreCase("FLOAT"    ) == 0 ) { return FLOAT; }
        else if ( id.compareToIgnoreCase("NUMBER"   ) == 0 ) { return NUMBER; }
        else if ( id.compareToIgnoreCase("STRING"   ) == 0 ) { return STRING; }
        else if ( id.compareToIgnoreCase("UNDEFINED") == 0 ) { return UNDEFINED; }
        return null;
    }
