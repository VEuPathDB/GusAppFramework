...
public abstract class RelationalDatabaseWriter
     ...
     */
    protected void writeTables(Schema schema)
                        throws IOException {
    ...
    protected void writeTable(Table table)
        ...
        oStream.write(
                "CREATE TABLE " + table.getSchema().getName() + "." + 
                table.getName() + " (\n");
        writeColumns(table);
        oStream.write(");\n\n");
        oStream.flush();
    ...
    protected void writeColumns(Table table)
        ...
        for (Iterator i = table.getColumns(true).iterator(); i.hasNext();) {
            ...
            first = false;
            log.debug("Writing column details for Table: '" + 
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeColumnList(Collection columns)
                            throws IOException {
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeIndexes(GusTable table)
                         throws IOException {
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeIndex(Index index)
                       throws IOException {
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeUQConstraints(GusTable table)
                               throws IOException {
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeUQConstraint(Constraint constraint)
                              throws IOException {
        oStream.write(
                "ALTER TABLE " + 
                constraint.getConstrainedTable().getSchema().getName() + 
                ".");
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected void writeFKConstraints(GusTable table)
                               throws IOException {
     ...
     * @throws IOException
     */
    protected void writeFKConstraint(Constraint constraint)
                              throws IOException {
        oStream.write(
                "ALTER TABLE " + 
                constraint.getConstrainedTable().getSchema().getName() + 
     ...
     * @throws IOException
     */
    protected void writeSequence(Sequence sequence)
                          throws IOException {
        oStream.write(
                "CREATE SEQUENCE " + 
                sequence.getTable().getSchema().getName() + ".");
        oStream.write(
                sequence.getName() + " START WITH " + sequence.getStart() + 
                ";\n");
        oStream.flush();
    }
