...
## $Id: InsertSequenceOntology.pm 3032 2005-06-24 17:36:15Z msaffitz $
##
#######################################################################
...
Inserts the Sequence Ontology from a so.obo file.
PURPOSEBRIEF

my $purpose = <<PLUGIN_PURPOSE;
Extracts the id, term, and definition fields from a so.obo file and inserts new entries into into the SRes.SequenceOntology table in the form so_id, ontology_name, so_version, so_cvs_version, term_name, definition.
PLUGIN_PURPOSE
