...
# ----------------------------------------------------------
package GUS::Supported::Plugin::InsertControl;
...
=head2 EXAMPLES
*For help
ga GUS::Supported::Plugin::InsertControl B<[options]> B<--help>
*For loading data into Control table
ga GUS::Supported::Plugin::InsertControl B<[options]> B<--data_file> data_file B<--array_design_id> array_design_id B<--e_subclass_view> e_subclass_view B<--debug> > logfile
*For loading data into Control table
ga GUS::Supported::Plugin::InsertControl B<[options]> B<--data_file> data_file B<--array_design_id> array_design_id B<--c_subclass_view> c_subclass_view B<--commit> > logfile 
