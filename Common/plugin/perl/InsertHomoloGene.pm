...
package GUS::Common::Plugin::InsertHomoloGene;
...
sub new {
  ...
  $self->initialize({requiredDbVersion => {},
		     cvsRevision => '$Revision: 3073 $', # cvs fills this in!
		     name => ref($self),
